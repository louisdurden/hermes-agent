    ...
    try:
        ...
        def _speak_scoped():
            ...
            with _config_profile_scope(profile):
                ...
                return text_to_speech_tool(text, tts_config_override=override)
...
async def speak_stream_ws(ws: "WebSocket") -> None:
    ...
    def _resolve():
        ...
        with _config_profile_scope(profile):
            ...
            # Desktop-only override (FX-138): these HTTP/WS routes are the
            # desktop speech path; messaging replies use the shared config.
